...
import auththenicateUser from './authServices';
import { handleHomePageData, handleStatPageData } from './serviceComponent';
import updatePageController from './updateService';
...
function statPageDispalyController() {
