...
import DataFetcher from './FetchDataClass';
import Interface from './InterfaceClass';

const api = 'https://nigeria-covid19-api.herokuapp.com/api/v1/nigeria/covid-19/';
// const api = 'http://localhost:3000/api/v1/nigeria/covid-19/';

const dataService = new DataFetcher(api);
...
export function handleHomePageData() {
...
export function handleStatPageData() {
  handleState();
  handleRegion();
  handleNational();
}
